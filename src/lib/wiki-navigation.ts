  ...
  hyperfactions: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Economy Management", href: "/plugins/hyperfactions/wiki/guides/economy-management" },
      ],
    },
    {
      title: "Concepts",
      items: [
        ...
        { title: "Economy", href: "/plugins/hyperfactions/wiki/concepts/economy" },
      ],
    },
    {
      title: "Commands",
      items: [
        ...
        { title: "Economy", href: "/plugins/hyperfactions/wiki/commands/economy" },
        { title: "Info & Viewing", href: "/plugins/hyperfactions/wiki/commands/info" },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Config: Announcements", href: "/plugins/hyperfactions/wiki/reference/config-announcements" },
        { title: "Config: Backup", href: "/plugins/hyperfactions/wiki/reference/config-backup" },
        { title: "Config: Chat", href: "/plugins/hyperfactions/wiki/reference/config-chat" },
        { title: "Config: Debug", href: "/plugins/hyperfactions/wiki/reference/config-debug" },
        { title: "Config: Economy", href: "/plugins/hyperfactions/wiki/reference/config-economy" },
        { title: "Config: Faction Perms", href: "/plugins/hyperfactions/wiki/reference/config-faction-permissions" },
        { title: "Config: Gravestones", href: "/plugins/hyperfactions/wiki/reference/config-gravestones" },
        { title: "Config: World Map", href: "/plugins/hyperfactions/wiki/reference/config-worldmap" },
      ],
    },
  ],
};
